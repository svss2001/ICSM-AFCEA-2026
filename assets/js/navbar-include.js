  ...
  function initNavbar() {
    ...
    if (hamburger && navLinksList) {
      ...
      document.addEventListener('click', function (e) {
        ...
        var linksBar = document.getElementById('nav-links-bar');
        var inSiteNav = siteNav && siteNav.contains(e.target);
        var inLinksBar = linksBar && linksBar.contains(e.target);

        if (!inSiteNav && !inLinksBar) {
